...
bichcheongmo는 성소수자 공조 단체를 위한 정적 웹사이트입니다. 순수 HTML, CSS, JavaScript로 구현되었으며, GitHub Actions에서 `_site/` 배포 산출물을 준비한 뒤 GitHub Pages로 서빙됩니다.
...
| **Build Tool** | Node.js script | - | `scripts/prepare-pages.js`로 Pages 배포 산출물 준비 |
